...
const CASES: Case[] = [
  ...
  },
  {
    ...
    answers: { canais: "Email, WhatsApp", erp: "Domínio", erp_conexao: "Instalado na máquina (desktop)" },
  ...
  },
  {
    ...
    answers: { erp: "Onvio", erp_conexao: "Acesso pela web / nuvem", canais: "Email" },
  ...
  },
  {
    ...
    answers: { erp: "Onvio", erp_conexao: "Acesso pela web / nuvem", api_acesso: "Não sei" },
  ...
  },
  {
    ...
    answers: { erp: "Onvio", erp_conexao: "Acesso pela web / nuvem", seguranca: "Não sei" },
  ...
  },
  {
    ...
    answers: { canais: "Email", erp: "Domínio", erp_conexao: "Instalado na máquina (desktop)" },
    blankSlots: ["processo"],
  ...
  },
  {
    ...
    answers: { erp: "Domínio", erp_conexao: "Acesso pela web / nuvem" },
  ...
  },
  {
    ...
    answers: { canais: "WhatsApp", erp: "Domínio", erp_conexao: "Acesso pela web / nuvem" },
  ...
  },
  {
    ...
    answers: { canais: "Email, WhatsApp", erp: "Domínio", erp_conexao: "Instalado na máquina (desktop)", destino: "Email" },
  ...
  },
  {
    ...
    answers: { erp: "Onvio", erp_conexao: "Acesso pela web / nuvem" },
